...
export default function Home() {
  ...
  return (
    <div className="bg-[#FDFCF8] overflow-x-hidden">
      ...
      <section className="py-24 md:py-36 px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-28 items-center">
          ...
          >
            ...
            <motion.img
              src="https://images.unsplash.com/photo-1438232992991-995b671e4b8a?w=900&q=80"
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.55, duration: 0.65, type: "spring", stiffness: 180 }}
              className="absolute -bottom-6 -right-3 md:-right-10 z-20 bg-amber-500 text-white rounded-2xl px-6 py-5 shadow-2xl"
            >
              <p className="font-black text-3xl leading-none font-serif">Est.</p>
              <p className="font-black text-4xl leading-none font-serif">1994</p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              "A lighthouse for the lost, a home for the family, and a sanctuary for the spirit."
            </motion.p>
            <motion.p variants={fadeUp} className="text-stone-600 leading-relaxed text-[15px]">
              Lakeside Baptist Church is a vibrant, multigenerational community rooted in the teachings
              of Christ. Since 1994 we have served the Lakeside region with passion, purpose, and an
              open door for every soul seeking belonging.
            </motion.p>
      ...
      <section className="py-24 md:py-32 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
            ...
            <InViewBlock delay={1}>
              <Link href="/services" className="text-amber-600 font-bold text-sm hover:underline underline-offset-4 whitespace-nowrap">
                All Service Times →
              </Link>
            </InViewBlock>
          </div>
          ...
          <InViewBlock delay={1}>
            <div className="flex flex-wrap gap-4 items-center bg-stone-50 border border-stone-100 rounded-2xl px-6 py-5">
              <p className="text-stone-500 text-sm font-medium flex-1 min-w-[180px]">
                📅&nbsp; <strong className="text-stone-700">Midweek</strong> — Bible Study (Wed 6 PM) · Youth Night (Fri 7 PM) · Prayer (Sat 8 AM)
              </p>
              <Link
                href="/services"
      ...
      <section className="px-6 pb-24 md:pb-32">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-stone-950/92 via-stone-900/72 to-transparent" />
            <div className="relative z-10 px-8 md:px-16 py-20 md:py-28 max-w-2xl">
              ...
              >
                ...
                <motion.p variants={fadeUp} className="text-stone-300 text-[15px] leading-relaxed mb-8 max-w-lg">
                  Whether you've never been to church or you've been away for years — there is no
                  judgement here. Just grace, warmth, and a family ready to welcome you home.
                </motion.p>
      ...
      <section className="bg-stone-50 py-24 md:py-32 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
            ...
            <InViewBlock delay={1}>
              <Link href="/blog" className="text-amber-600 font-bold text-sm hover:underline underline-offset-4 whitespace-nowrap">
                All Sermons & Blog →
              </Link>
            </InViewBlock>
          </div>
          ...
          <div className="grid lg:grid-cols-5 gap-7">
                ...
                >
                  <div className="relative overflow-hidden" style={{ aspectRatio: "16/9" }}>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <motion.div whileHover={{ scale: 1.12 }} className="w-16 h-16 rounded-full bg-white/90 flex items-center justify-center shadow-2xl">
                  ...
                  <div className="p-7">
                    ...
                    <p className="text-stone-500 text-sm mb-4">Pastor Emmanuel Adeyemi</p>
                    <div className="flex items-center justify-between">
                      <div className="flex gap-5 text-stone-400 text-xs font-medium">
                        <span>📅 Mar 23, 2025</span>
                        <span>🕐 52 min</span>
                      </div>
                      <Link href="/blog" className="text-amber-600 font-bold text-xs hover:underline">Watch →</Link>
                    </div>
                  </div>
                </motion.div>
              );
            ...
            <div className="lg:col-span-2 flex flex-col gap-5">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <span className="text-[10px] font-black uppercase tracking-widest text-amber-600">{s.series}</span>
                      <h4 className="font-black font-serif text-stone-900 text-[15px] leading-snug mt-1 mb-1 group-hover:text-amber-600 transition-colors line-clamp-2">{s.title}</h4>
                      <p className="text-stone-400 text-xs truncate">{s.pastor}</p>
                      <div className="flex gap-3 mt-2 text-stone-400 text-[11px]">
                        <span>{s.date}</span><span>·</span><span>{s.duration}</span>
                      </div>
                    </div>
                  </motion.div>
                );
              ...
              <InViewBlock delay={2} className="mt-auto pt-1">
                ...
                >
                  Browse All Sermons <span className="text-lg leading-none">→</span>
                </Link>
              </InViewBlock>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
            <InViewBlock>
              ...
              <h2 className="text-4xl md:text-6xl font-black font-serif text-stone-900 mt-2 leading-tight">
                Coming Up at{" "}
                <span className="text-amber-600">Lakeside</span>
              </h2>
            </InViewBlock>
            <InViewBlock delay={1}>
              <Link href="/blog" className="text-amber-600 font-bold text-sm hover:underline underline-offset-4 whitespace-nowrap">
                ...
                >
                  <div className="relative overflow-hidden" style={{ aspectRatio: "16/9" }}>
                    ...
                    <div className="absolute top-4 right-4 w-14 h-14 rounded-xl bg-amber-500 flex flex-col items-center justify-center text-white shadow-lg">
                      <span className="font-black text-xl leading-none">{ev.date}</span>
                      <span className="text-[9px] font-bold uppercase tracking-wider text-amber-100">{ev.month}</span>
                    </div>
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-stone-500 text-sm leading-relaxed line-clamp-2">{ev.desc}</p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-stone-500 text-lg max-w-xl mx-auto leading-relaxed">
              Our team is always ready to help, pray with you, or simply chat. Reach out any time.
            </motion.p>
